...
import type { Role, RecentGame } from './types'
...
export const StatsSection = ({ roles, recentGames }: StatsSectionProps) => {
  return (
    <motion.section variants={itemVariants} className="w-full">
      ...
      <div className="p-5 rounded-lg bg-card/40 backdrop-blur-sm border border-primary/20 relative">
        ...
        <h3 className="font-bold mb-4 text-foreground/80">Role Performance</h3>
        <RoleStats roles={roles} />
        
        <h3 className="font-bold mt-8 mb-3 text-foreground/80">Recent Games</h3>
